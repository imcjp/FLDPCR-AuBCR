...
1. Our proposed AuBCR model is implemented in the file [**aubcr.py**](https://github.com/imcjp/FLDPCR-AuBCR/blob/main/dpcrpy/bitMethods/aubcr.py).
2. The design of AuBCR is based on a rigorous theoretical derivation. Limited by the length of the paper, we show the relevant theoretical derivations in poof.pdf.
